...
public class MenuHelper {
    ...
    public static void initColorMenu(View view, JMenuBar menuBar) {
        ...
        addMenuItem(colorMenu, new StyledEditorKit.ForegroundAction("Dark Blue", Color.blue));
        addMenuItem(colorMenu, new StyledEditorKit.ForegroundAction("Blue", Color.cyan));
